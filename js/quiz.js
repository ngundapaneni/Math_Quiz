$(document).ready(function() {
    ...
    function nextQuestion() {
        if (currentQuestion < 10) {
			...
			var newQuestion = '<span class="question">' + questions[currentQuestion].questionNo + ') ' + questions[currentQuestion].question+'</span><br><div id="answerContainer"><input type="radio" name="option" class="option" value="0"><span class="answer">'+questions[currentQuestion].answers[0]+'</span><br><input type="radio" name="option" class="option" value="1"><span class="answer">'+questions[currentQuestion].answers[1]+'</span><br><input type="radio" name="option" class="option" value="2"><span class="answer">'+questions[currentQuestion].answers[2]+'</span><br><input type="radio" name="option" class="option" value="3"><span class="answer">'+
								questions[currentQuestion].answers[3]+'</span><br></div><div id="submitContainer"><input type="button" class="button" id="submit" value="Submit Answer"><input type="button" class="button" id="retry" value="Retry Quiz"></div>';
